...
OGA_FORM_SOURCE="${OGA_FORM_SOURCE:-github}"
OGA_FORM_GITHUB_REPO="${OGA_FORM_GITHUB_REPO:-OpenNSW/one-trade-templates}"
OGA_FORM_GITHUB_REF="${OGA_FORM_GITHUB_REF:-main}"
OGA_FORM_MANIFEST_REFRESH_INTERVAL="${OGA_FORM_MANIFEST_REFRESH_INTERVAL:-5m}"
